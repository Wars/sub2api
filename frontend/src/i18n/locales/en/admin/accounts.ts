export default {
    accounts: {
      ...
      openai: {
        ...
        codexCLIOnlyDesc:
          'Only applies to OpenAI OAuth or API Key accounts. When enabled, only Codex official client families are allowed; when disabled, the gateway bypasses this restriction and keeps existing behavior.',
